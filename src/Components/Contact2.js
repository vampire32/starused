	...
	return (
		<div className=" bg-white text-black px-8 py-12">
			<div className="text-center w-full">
				<h1 className=" text-[#d9c7a4] font-extrabold text-[2.5rem]">Get In Touch</h1>
				<p>
					Tell Us a Story.Info about any broken link. Suggestions for
					improvement of BugsFixer.
					<br />
					Tell us the Current Price of Products in Your City. If you have any
					other questions, you can contact us
				</p>
				<svg
			...
			<div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  bg-[#d9c7a4] text-white rounded-lg shadow-lg">
						...
						>
							<defs>
								...
								<linearGradient
									...
									x2="462.91"
									y2="559.69"
									xlinkHref="#ffff-45fa-49e0-9a60-1b0612516196"
								/>
							</defs>
							...
							<path
								...
								opacity="0.1"
							/>
							<circle cx="779.73" cy="238.18" r="99.96" fill="#000000" />
							<path
							...
							<path
								...
								opacity="0.1"
							/>
							<circle cx="550.08" cy="390.01" r="99.96" fill="#000000" />
							<path
							...
							<path
								...
								opacity="0.1"
							/>
							<circle cx="312.85" cy="315.36" r="99.96" fill="#000000" />
							<path
							...
							<g opacity="0.1">
								...
								<path
									d="M814.55,650.26s-9.94-.27-12.94-.81c0,.51,0,.81,0,.81-.78.78,13.76,1.18,13.76,1.18a1,1,0,0,1,.54.22C815.38,650.26,814.55,650.26,814.55,650.26Z"
									transform="translate(-52 -162.63)"
									fill="url(#ffff-2b04-44c8-bb7b-982389166780)"
								/>
								<path
									d="M831.85,634.14c-.4-.39-.79-5.89-.79-5.89a1.69,1.69,0,0,1-.67.24c.14,1.66.41,4.21.67,4.47s2,10.22,1.57,14.94,0,4.71,0,4.71-12.75,1.87-15.84.62c0,.17.09.36.12.56.39,2.36,16.51,0,16.51,0s-.4,0,0-4.71S832.24,634.54,831.85,634.14Z"
									transform="translate(-52 -162.63)"
							...
							<path
								...
								opacity="0.1"
							/>
							<circle cx="776.11" cy="438.7" r="9.04" fill="#ffff" />
							<path
							...
							<path
								...
								opacity="0.1"
							/>
							<circle cx="758.03" cy="419.83" r="8.84" fill="#ffff" />
							<path
				...
				<form>
					<div>
						<label className="uppercase text-sm text-white font-bold">
							Full Name
						</label>
						<input
					...
					<div className="mt-8">
						...
						<input
							className="w-full bg-white text-black mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
							type="text"
						/>
					</div>
					<div className="mt-8">
						...
						<textarea className="w-full h-32 bg-white text-black mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
					</div>
					<div className="mt-8">
